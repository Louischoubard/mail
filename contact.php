...
if(!empty($_POST['name']) && !empty($_POST['email']) && !empty($_POST['subject']) && !empty($_POST['message'])){
	...
	$bdd = new pdo('mysql:host=localhost;dbname=id15196332_gite','id15196332_louis','4l5G]e+pfxkQ)x_@');

	$insertmail = $bdd->prepare('INSERT INTO mail (name, email, subject, message) VALUES (:name, :email, :subject, :message)');
	$insertmail->execute([
		'name' => $name,
		'email' => $email,
		'subject' => $subject,
	...
	$insertnbrmail = $bdd->prepare('INSERT INTO nbr_mail(mail) VALUES (:mail)');
	$insertnbrmail->execute(['mail' => $email]);
	$select = $bdd->prepare('SELECT * FROM mail WHERE email = $email');
	$select->execute();
	$s = $select->fetch();
	$body = '
...
<html xmlns:v="urn:schemas-microsoft-com:vml">
														...
														<table class="center" cellpadding="0" cellspacing="0">
															<tr>
																<td style="line-height:0;">
																	<a target="_blank" style="text-decoration:none;" href="https://gite-chercherelles.ueuo.com">Gite</a>
																</td>
															</tr>
														</table>
													</th>
														...
														<table width="100%" cellpadding="0" cellspacing="0">
															<tr>
																<td data-color="text" data-size="size navigation" data-min="10" data-max="22" data-link-style="text-decoration:none; color:#888;" class="nav" align="right" style="font:bold 13px/15px Arial, Helvetica, sans-serif; color:#888;">
																	<a target="_blank" style="text-decoration:none; color:#888;" href="https://gite-chercherelles.ueuo.com">Accueil</a> &nbsp; &nbsp; <a target="_blank" style="text-decoration:none; color:#888;" href="https://gite-chercherelles.ueuo.com/admin/">Admin</a> &nbsp; &nbsp; <a target="_blank" style="text-decoration:none; color:#888;" href="https://gite-chercherelles.ueuo.com/#contact">Contact</a>
																</td>
															</tr>
														</table>
													</th>
						...
						<tr>
							<td data-bgcolor="bg-module" bgcolor="#eaeced">
								<table class="flexible" width="600" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
									<tr>
										<td class="img-flex">
										<img src="https://i.ibb.co/5hcdWgL/ext11.jpg" style="vertical-align:top; width: 100%; height: auto;
											" align="center" alt="" />
										</td>
									</tr>
									<tr>
														...
														<table width="134" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
															<tr>
																<td data-bgcolor="bg-button" data-size="size button" data-min="10" data-max="16" class="btn" align="center" style="font:12px/14px Arial, Helvetica, sans-serif; color:#f8f9fb; text-transform:uppercase; mso-padding-alt:12px 10px 10px; border-radius:2px;" bgcolor="#7bb84f">
																	<a target="_blank" style="text-decoration:none; color:#f8f9fb; display:block; padding:12px 10px 10px;" href="https://gite-chercherelles.ueuo.com/affichemail.php?id=' . $s['id'] . '">Afficher plus de details</a>
																</td>
															</tr>
														</table>
													</td>
    ...
    $header = "From: Contact@gite-chercherelles.com"."\r\n"."Reply-To: " . $email . "\r\n";
    $header .= "Content-type: text/html; charset=UTF-8\r\n";


    $to = 'Louis.choubard@gmail.com';
    $subject = 'Gite des Chercherelles';

	$mail = mail($to, $subject, $body, $header);
	$erreur = 'Le message a été envoyé';
